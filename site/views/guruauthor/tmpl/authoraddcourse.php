            ...
            <form action="<?php echo JURI::root(); ?>index.php?option=com_guru?view=guruAuthor" class="uk-form uk-form-horizontal wk-form wk-form-horizontal" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
                ...
                <ul class="uk-switcher wk-switcher" id="subnav-pill-content-1">
                    <li id="general-tab-content" class="uk-active wk-active content-tab">
                        ...
                        <div class="uk-form-row wk-form-row" id="lessons_release_td"  <?php if ($program->course_type ==1){$style="style=display:table-row;"; echo $style;} else{$style="style=display:none;"; echo $style;} ?>>
                            <label class="uk-form-label wk-form-label" for="name">
                        ...
                        <div class="uk-form-row wk-form-row" id="lessons_show_td"  <?php if ($program->course_type ==1){$style="style=display:table-row;"; echo $style;} else{$style="style=display:none;"; echo $style;} ?>>
                            <label class="uk-form-label wk-form-label" for="name">
                        ...
                        <div class="uk-form-row wk-form-row">
                            ...
                            <div class="uk-form-controls wk-form-controls">
                                ...
                                <div id="avg_certificate" class="uk-float-left wk-float-left" style=" <?php if($program->certificate_term  == "4" || $program->certificate_term  == "6" ){echo 'display:table-row;';}else{echo 'display:none; ';}?>">
                        ...
                        <div class="uk-form-row wk-form-row" id="coursecertifiactemsg" style=" <?php if($program->certificate_term  != "1" && $program->certificate_term  != "0"){echo 'display:block;';}else{echo 'display:none;';}?>">
                            <label class="uk-form-label wk-form-label" for="name">
