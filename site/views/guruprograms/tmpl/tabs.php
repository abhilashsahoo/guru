...
<?php
    ...
    <script type="text/javascript">
            ...
            ?>
                    document.write('<a target="_blank" href="<?php echo JURI::root()."index.php?option=com_guru&controller=guruTasks&task=download&media=".intval($element->id)."&course=".intval($course_id)."&tmpl=component&format=raw"; ?>"><img src="components/com_guru/images/doc.gif" alt="<?php echo $element->type; ?>" align="absmiddle" />&nbsp;<?php echo $element->local; ?></a>');
            <?php
                }
                elseif($element->type == "docs" && trim($element->url) != ""){
            ?>
                    document.write('<a target="_blank" href="<?php echo $element->url; ?>"><img src="components/com_guru/images/doc.gif" alt="<?php echo $element->type; ?>" align="absmiddle" />&nbsp;<?php echo $element->name; ?></a>');
            <?php
                }
                elseif($element->type == "file" && trim($element->local) != ""){
            ?>
                    document.write('<a target="_blank" href="<?php echo JURI::root()."index.php?option=com_guru&controller=guruTasks&task=download&media=".intval($element->id)."&course=".intval($course_id)."&tmpl=component&format=raw"; ?>"><img src="components/com_guru/images/file.gif" alt="<?php echo $element->type; ?>" align="absmiddle" />&nbsp;<?php echo $element->local; ?></a>');
            <?php
                }
            }
            else{
